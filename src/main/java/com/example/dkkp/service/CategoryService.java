...
public class CategoryService {
  ...
  public List<Category_Entity> getFilteredCategories(String id, String name, String idParent, String idBrand, Boolean isBaseProduct, String sortField, String sortOrder, int offset, int setOff) {
    return categoryDao.getFilteredCategories(id, name, idParent, idBrand, isBaseProduct, sortField, sortOrder, offset, setOff);
  }

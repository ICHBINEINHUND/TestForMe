...
//  @FXML
//  private MFXTableColumn<Product_Base_Entity> QUANTITY;
//  @FXML
//  private MFXTableColumn<Product_Base_Entity> VIEW_COUNT;
//  @FXML
//  private MFXTableColumn<Product_Base_Entity> DISCOUNT;
//  @FXML
...
//
//  private void setCol() {
//    ID_SP.setRowCellFactory(_ -> new MFXTableRowCell<>(Product_Base_Entity::getID_SP));
//    NAME_SP.setRowCellFactory(_ -> new MFXTableRowCell<>(Product_Base_Entity::getNAME_SP));
//    ID_CATEGORY.setRowCellFactory(_ -> new MFXTableRowCell<>(Product_Base_Entity::getID_CATEGORY));
//    PRICE_SP.setRowCellFactory(_ -> new MFXTableRowCell<>(Product_Base_Entity::getPRICE_SP));
//    VIEW_COUNT.setRowCellFactory(_ -> new MFXTableRowCell<>(Product_Base_Entity::getVIEW_COUNT));
//    QUANTITY.setRowCellFactory(_ -> new MFXTableRowCell<>(Product_Base_Entity::getQUANTITY));
//    DISCOUNT.setRowCellFactory(_ -> new MFXTableRowCell<>(Product_Base_Entity::getDISCOUNT));
//  }
//
...
//    return FXCollections.observableArrayList(new Product_Base_Entity("APTX-4869", "NVIDIA GeForce RTX 4090", null, "GPU", 2500.0, null, 10000, 5, 2.5, null), new Product_Base_Entity("BG2022", "AMD Ryzen 9 7950X", null, "CPU", 799.0, null, 2000, 15, 10.0, null), new Product_Base_Entity("DS501", "Samsung 980 Pro SSD", null, "Storage", 200.0, null, 5000, 25, 5.0, null));
//  }
//}
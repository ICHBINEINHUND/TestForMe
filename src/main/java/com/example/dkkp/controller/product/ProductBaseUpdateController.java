...
public class ProductBaseUpdateController implements TableInterface {
    ...
    public void initialize() {
        ...
        setCol();
        setWidth();
        System.out.println("trong bang update " + productEntity.getID_BASE_PRODUCT() + " " + productEntity.getNAME_PRODUCT());
        ...
        pushEntity();
        backBtn.setOnMouseClicked(event -> productBaseController.setMainView("/com/example/dkkp/ProductBaseView.fxml", productBaseController));
    ...
    public ObservableList<Product_Attribute_Values_Entity> getAttributeValue() {
        ...
        Product_Attribute_Values_Entity attributeValueEntity = new Product_Attribute_Values_Entity(null, 5, null, null);

...
public class ImportController {
  ...
  private void ftr() {
    ftrBtn.setOnAction(_ -> {
      FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/dkkp/ImportDetail/ImportFilter.fxml"));
  ...
  private void crt() {
    crtBtn.setOnAction(_ -> {
      FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/dkkp/ImportDetail/ImportDetailCreate.fxml"));
      main.getChildren().clear();
      try {
        main.getChildren().add(loader.load());
      } catch (IOException e) {
